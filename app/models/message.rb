...
#  call_duration(Call duration in seconds) :integer
#  call_metadata                           :jsonb
#  call_status                             :integer
#  content                                 :text
...
#  index_messages_on_call_status                         (call_status)
...
#  index_messages_on_conversation_call_status            (conversation_id,content_type,call_status)
#  index_messages_on_conversation_id                     (conversation_id)
#  index_messages_on_conversation_id_created_at_id_desc  (conversation_id,created_at DESC,id DESC)
#  index_messages_on_created_at                          (created_at)
#  index_messages_on_inbox_id                            (inbox_id)
#  index_messages_on_sender_type_and_sender_id           (sender_type,sender_id)
#  index_messages_on_source_id                           (source_id)
#  index_messages_on_source_id_and_created_at            (source_id,created_at)
#
...
class Message < ApplicationRecord
  ...
  store :content_attributes, accessors: [:submitted_email, :items, :submitted_values, :email, :in_reply_to, :deleted,
                                         ...
                                         :whatsapp_buttons, :whatsapp_interactive_type], coder: JSON
